...
export function WebChatInterface() {
  const [messages, setMessages] = useState<ChatMessage[]>([
    {
      id: '1',
      content: 'Hello! I\'m your AI farming assistant for Niigata. How can I help with your strategic farming planning today?',
      sender: 'ai',
      timestamp: new Date(),
    },
  ]);
      ...
      <form onSubmit={sendMessage} className="p-4 border-t border-gray-200">
        <div className="flex items-center">
          ...
          <input
            ...
            placeholder="Ask about strategic farming in Niigata..."
